...
import { colorToHexCode, colorToShortcode, shortcodeToColor } from "./color_item.js";
function beginCircle(context, x, y, r) {
    context.beginPath();
    if (r < 0.05) {
...
export class ShapeItem extends BaseItem {
    ...
    static validString(key) {
        ...
        for (let i = 0; i < sourceLayers.length; ++i) {
            ...
            const quads = [undefined, undefined, undefined, undefined];
            let anyFilled = false;
     ...
     */
    cloneLayers() {
        return JSON.parse(JSON.stringify(this.layers), (key, value) => value === null ? undefined : value);
    }
    /**
...
const SHAPE_ITEM_CACHE = new Map();
//# sourceMappingURL=shape_item.js.map